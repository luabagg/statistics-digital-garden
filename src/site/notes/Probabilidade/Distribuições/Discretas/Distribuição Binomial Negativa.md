...
- **[[Probabilidade/Distribuições/Discretas/Distribuição Geométrica\|Distribuição Geométrica]]:** Caso especial da binomial negativa com $r = 1$, modelando o número de fracassos até o **primeiro sucesso**.
- **[[Probabilidade/Distribuições/Discretas/Distribuição Binomial\|Distribuição Binomial]]:** Modela o número de sucessos em um número **fixo** de ensaios. A binomial negativa, por outro lado, fixa o número de sucessos e deixa variável o número de fracassos (ou tentativas).
