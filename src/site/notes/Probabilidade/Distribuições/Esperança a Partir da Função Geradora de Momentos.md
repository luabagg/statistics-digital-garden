---
{"dg-publish":true,"permalink":"/probabilidade/distribuicoes/esperanca-a-partir-da-funcao-geradora-de-momentos/","dg-note-properties":{}}
---
...
$$
2. **Exemplo**:
   Considere uma variável aleatória discreta $X$ com [[Probabilidade/Distribuições/Discretas/Distribuição de Bernoulli\|Distribuição de Bernoulli]], onde $P(X=1) = p$ e $P(X=0) = 1-p$. A função geradora de momentos é:
$$
