---
{"dg-publish":true,"permalink":"/probabilidade/distribuicoes/continuas/distribuicao-gama/","created":"2025-05-20T09:27:27.975-03:00"}
---
...
$$
   ...
   - $\Gamma(k)$ é a [[Probabilidade/Distribuições/Contínuas/Função Gama\|Função Gama]].
...
6. **Relação com Outras Distribuições**:
   - A distribuição Gama é uma generalização da [[Probabilidade/Distribuições/Contínuas/Distribuição Exponencial\|Distribuição Exponencial]].
   - Quando $k = 1$, a distribuição Gama se torna a [[Probabilidade/Distribuições/Contínuas/Distribuição Exponencial\|Distribuição Exponencial]].
